...
def main():
    st.title("This is a title that I have")
    ...
    st.number_input("Enter your age here:", 0, 10)

    st.slider("Enter your age here:", 18, 40, value=30)

    data_set = st.date_input("Enter the appointment date :")
    ...
    st.text_area("Write an essay on why you should be considered for the scholarship opportunity", height=500)
    ...
    st.warning("The directory you are trying to save does not exist")
